...
import 'package:counter_app/presentation/widgets/hourly_forecast_item.dart';
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        final hourlyForecast =
                            currentWeatherData.weatherList[index + 1];
                        final hourlySky = currentWeatherData
                            .weatherList[index + 1]['weather'][0]['main'];
                        final hourlyTemp =
